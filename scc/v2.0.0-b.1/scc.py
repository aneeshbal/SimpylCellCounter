...
#################### OUTPUT ####################
	...
	#Debug image generation
		if mode == 'debug':
		#Draw contours
			images[4] = cv2.drawContours(images[0], contours[0], -1, (0,0,240), 2)
			images[4] = cv2.drawContours(images[0], contours[1], -1, (0,140,255), 2)
			images[4] = cv2.drawContours(images[0], contours[2], -1, (0,255,255), 2)
			images[4] = cv2.drawContours(images[0], contours[3], -1, (200,160,0), 2)
			
		#Notate counts
			cv2.putText(images[4], '+!Area:'+str(len(contours[0])), (8,144), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,240), 2)
			...
			cv2.putText(images[4], 'Cells:'+str(len(contours[3])), (8,36), cv2.FONT_HERSHEY_SIMPLEX, 1, (200,160,0), 2)
